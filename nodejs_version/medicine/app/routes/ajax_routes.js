...
//        myHeaders.append("Authorization", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1Mzg0MDE4NDQsInVzZXJuYW1lIjoiSmltIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE1MzgzNjU4NDR9.sJM4KsZt2gT2mfmGT6iFXUeWuiFSO0zlyLa-WQ77Of8");
...
//                     //"Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1Mzg0MDE4NDQsInVzZXJuYW1lIjoiSmltIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE1MzgzNjU4NDR9.sJM4KsZt2gT2mfmGT6iFXUeWuiFSO0zlyLa-WQ77Of8"},
//        })
...
//        };
        ...
        fetch("http://localhost:4000/users", { 
           ...
           .then(function(text){
               ...
               //res.send(text);
                ...
                //res.cookie('token', token, { httpOnly: true });
                res.cookie('token', token, {httpOnly: true, maxAge:10000}); //600000是60分鐘
    ...
    app.post('/login', function(req, res) {
		...
		if (err) {
			...
			res.cookie('token', rows[0].token, { httpOnly: true, maxAge:10000 });
            res.cookie('username', username, {httpOnly: true, maxAge:10000});
			res.redirect('/');
		}
		else {
